...
if __name__ == '__main__':
    selection_method = 'ranking'
    create_report("Tests/Test_statistics/test_03.csv", 'ranking')
    for _ in range(30):
        create_report("Tests/Test_statistics/test_03.csv", main()[1:])
    selection_method = 'tournament'
    create_report("Tests/Test_statistics/test_03.csv", 'tournament')
    for _ in range(30):
        create_report("Tests/Test_statistics/test_03.csv", main()[1:])
    selection_method = 'roulette'
    create_report("Tests/Test_statistics/test_03.csv", 'roulette')
    for _ in range(30):
        create_report("Tests/Test_statistics/test_03.csv", main()[1:])
