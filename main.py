...
def main():
    ...
    for weight in ex_weight:
        plt.plot(weight, my_sellers_base.get_seller_by_id('1').delivery.get_cost(weight), 'ko')
        plt.plot(weight, my_sellers_base.get_seller_by_id('2').delivery.get_cost(weight), 'ro')
    ...
    for quant in ex_quantity:
        plt.plot(quant, my_sellers_base.get_seller_by_id('1').discount.get_disc()(quant), 'ko')
        plt.plot(quant, my_sellers_base.get_seller_by_id('2').discount.get_disc()(quant), 'r*')
